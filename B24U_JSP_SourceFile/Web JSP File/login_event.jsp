...
<body>
		...
		<div class="outerbox">
			...
			<div class="formbox">
				<div class="form">
					<form action="/B24U/LoginEvent" method="post">
					...
					<span>
						<p><a href="forgot_event_password.jsp"><b>Forgot Password?</b></a></p><p>Don't have an account?<a href="registar_event.jsp"><b>Sign Up</b></a></p>
					</span>
				</div>
			</div>
