...
public class EventContribute extends HttpServlet 
{
    public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
    {
        ...
        { 
            ...
            rs.close(); 
            con.close(); 
            out.print("<html><body><script>alert('Thank you....!!!');window.location='/B24U/Event/e_contribute.jsp';</script><body></html>");
        } 
        catch (Exception e) 
        { 
            e.printStackTrace();
            out.print("<html><body><script>alert('Something went wrong....!!!');window.location='/B24U/Event/e_contribute.jsp';</script><body></html>");
        } 
    }
}
